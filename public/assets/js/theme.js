...
var dropzoneInit = function dropzoneInit() {
    ...
    !!dropzones.length && dropzones.forEach(function (item) {
        ...
        var options = merge({
            url: '/assets/img/complaint_media/',
...
//     parallelUploads: 100,
//     addRemoveLinks: true,
//     autoProcessQueue: false, // Disable auto process queue
//     init: function() {
//         var myDropzone = this;
...
//                 myDropzone.processQueue(); // Process the files in the Dropzone queue
//             } else {
//                 this.submit(); // Submit the form if no files are queued in Dropzone
//             }
//         });

//         // On successful file upload
//         myDropzone.on("successmultiple", function(files, response) {
//             document.querySelector('form').submit(); // Submit the form after files are uploaded
//         });
...
var topProductsInit = function topProductsInit() {
    ...
    if ($echartBarTopProducts) {
        var data = [
            ['product', '2024', '2025'],
            ['GE', 43, 85, 98, 95],
            ['Marketing', 83, 73, 24, 25],
            ['Corporate', 86, 62, 16, 67],
            ['Legal', 72, 53, 16, 98],
            ['IGE', 80, 50, 58, 86],
            ['Powmex', 50, 70, 78, 94],
            ['IT & Cyber', 80, 90, 88, 65]
        ];
